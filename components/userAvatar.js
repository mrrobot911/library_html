...
export const userAvatar = () => {
    ...
    if (userId) {
        ...
        userAvatarLogo.title=`${db[userId].firstName.toUpperCase()[0] + db[userId].firstName.toLowerCase().slice(1)} ${db[userId].lastName.toUpperCase()[0] + db[userId].lastName.toLowerCase().slice(1)}`
    } else {
